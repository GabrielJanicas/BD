...
```
TipoFornecedor: Codigo,Designcao,Prazo
PK: Codigo
FK(s): (nome)

CodigoPagamento: Codigo,Designacao,Prazo
PK: Codigo
FK(s):CodigoPag_Codigo,TipoForn_Codigo

Fornecedor: Nome,Morada, Nif, email, CondPag_Codigo,TipoForn_Codigo
PK: Numero
...
Produto: (<u>Codigo</u>,Nome,Preco,TaxaIVA)
TipoFornecedor: (<u>Codigo</u>,Nome)
CodigoPagamento(<u>Codigo</u>,Condicao,Prazo)
Fornecedor(<u>NIF</u>,Nome,Morada,<span style ="text-decoration:underline;text-decoration-style: dotted;">CondPag_Codigo</span>)
Itens(<u>ID</u>,Produto_Codigo,Encomenda_Numero,Quantidade)
...
Fornecedor:
	- TipoFornecedor: Grau Binário, Cardinalidade N:1, Obrigatoriedade: Obrigatório
	- CondicoesPagamento: Grau Binário, Cardinalidade N:1, Obrigatoriedade: Obrigatório
	- Encomendas: Grau Binário, Cardinalidade 1:N, Obrigatoriedade: Não Obrigatório

Encomendas:
	- Items: Grau Binário, Cardinalidade 1:N, Obrigatoriedade: Obrigatório
	- Fornecedor: Grau Binário, Cardinalidade N:1, Obrigatoriedade: Obrigatório

Items:
	- Produtos: Grau Binário, Cardinalidade N:1, Obrigatoriedade: Obrigatório
	- Encomendas: Grau Binário, Cardinalidade 1:N, Obrigatoriedade: Obrigatório
Produtos:
	- Items : Grau Binário, Cardinalidade 1:N, Obrigatoriedade: Obrigatório
```
